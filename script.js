...
const PROJECTS = [
  {
    ...
    cover: img('VISIONE TELAIO UNIQLO/project-01.webp'),
    images: [
      img('VISIONE TELAIO UNIQLO/project-01.webp'),
      img('VISIONE TELAIO UNIQLO/project-02.webp'),
      img('VISIONE TELAIO UNIQLO/project-03.webp'),
      img('VISIONE TELAIO UNIQLO/project-04.webp'),
      img('VISIONE TELAIO UNIQLO/project-05.webp'),
      img('VISIONE TELAIO UNIQLO/project-06.webp'),
      img('VISIONE TELAIO UNIQLO/project-07.webp'),
      img('VISIONE TELAIO UNIQLO/project-08.webp'),
      img('VISIONE TELAIO UNIQLO/project-09.webp'),
      img('VISIONE TELAIO UNIQLO/project-010.webp'),
      img('VISIONE TELAIO UNIQLO/project-021.webp'),
      img('VISIONE TELAIO UNIQLO/project-023.webp'),
      img('VISIONE TELAIO UNIQLO/project-035.webp'),
      img('VISIONE TELAIO UNIQLO/project-052.webp'),
      img('VISIONE TELAIO UNIQLO/project-053.webp'),
      img('VISIONE TELAIO UNIQLO/project-055.webp'),
      img('VISIONE TELAIO UNIQLO/project-068.webp'),
      img('VISIONE TELAIO UNIQLO/project-070.webp'),
      img('VISIONE TELAIO UNIQLO/project-071.webp'),
      img('VISIONE TELAIO UNIQLO/project-087.webp'),
      img('VISIONE TELAIO UNIQLO/project-0101.webp'),
      img('VISIONE TELAIO UNIQLO/project-0115.webp'),
      img('VISIONE TELAIO UNIQLO/project-0116.webp'),
      img('VISIONE TELAIO UNIQLO/project-0117.webp'),
      img('VISIONE TELAIO UNIQLO/project-0118.webp'),
      img('VISIONE TELAIO UNIQLO/project-0119.webp'),
      img('VISIONE TELAIO UNIQLO/project-0120.webp'),
      img('VISIONE TELAIO UNIQLO/project-0121.webp'),
      img('VISIONE TELAIO UNIQLO/project-0122.webp'),
      img('VISIONE TELAIO UNIQLO/project-0123.webp'),
      img('VISIONE TELAIO UNIQLO/project-0124.webp'),
    ]
  },
  {
    id: '02',
    ...
    cover: img('VISIONE TELAIO CP COMPANY/project-061.webp'),
    images: [
      img('VISIONE TELAIO CP COMPANY/project-061.webp'),
      img('VISIONE TELAIO CP COMPANY/project-057.webp'),
      img('VISIONE TELAIO CP COMPANY/project-062.webp'),
      img('VISIONE TELAIO CP COMPANY/project-059.webp'),
      img('VISIONE TELAIO CP COMPANY/project-060.webp'),
      img('VISIONE TELAIO CP COMPANY/project-063.webp'),
      img('VISIONE TELAIO CP COMPANY/project-064.webp'),
  ...
  },
  {
    ...
    description: '',
    cover: img('VISIONE TELAIO SOTA/project-015.webp'),
    images: [
      img('VISIONE TELAIO SOTA/project-015.webp'),
      img('VISIONE TELAIO SOTA/project-016.webp'),
      img('VISIONE TELAIO SOTA/project-017.webp'),
      img('VISIONE TELAIO SOTA/project-018.webp'),
      img('VISIONE TELAIO SOTA/project-020.webp'),
      img('VISIONE TELAIO SOTA/project-025.webp'),
      img('VISIONE TELAIO SOTA/project-034.webp'),
      img('VISIONE TELAIO SOTA/project-042.webp'),
      img('VISIONE TELAIO SOTA/project-043.webp'),
      img('VISIONE TELAIO SOTA/project-044.webp'),
      img('VISIONE TELAIO SOTA/project-047.webp'),
      img('VISIONE TELAIO SOTA/project-050.webp'),
      img('VISIONE TELAIO SOTA/project-069.webp'),
      img('VISIONE TELAIO SOTA/project-072.webp'),
    ]
  },
  {
    id: '04',
    ...
    description: '',
    cover: img('VISIONE TELAIO EDITORIALE/project-014.webp'),
    images: [
      img('VISIONE TELAIO EDITORIALE/project-014.webp'),
      img('VISIONE TELAIO EDITORIALE/project-019.webp'),
      img('VISIONE TELAIO EDITORIALE/project-022.webp'),
      img('VISIONE TELAIO EDITORIALE/project-024.webp'),
      img('VISIONE TELAIO EDITORIALE/project-037.webp'),
      img('VISIONE TELAIO EDITORIALE/project-046.webp'),
      img('VISIONE TELAIO EDITORIALE/project-048.webp'),
      img('VISIONE TELAIO EDITORIALE/project-049.webp'),
      img('VISIONE TELAIO EDITORIALE/project-088.webp'),
    ]
  },
  {
    id: '05',
    ...
    cover: img('VISIONE TELAIO/project-090.webp'),
    images: [
      img('VISIONE TELAIO/project-090.webp'),
      img('VISIONE TELAIO/project-091.webp'),
      img('VISIONE TELAIO/project-092.webp'),
      img('VISIONE TELAIO/project-093.webp'),
      img('VISIONE TELAIO/project-094.webp'),
    ]
  },
  {
    id: '06',
    ...
    cover: img('LOOKBOOK RF_LL/project-026.webp'),
    images: [
      img('LOOKBOOK RF_LL/project-026.webp'),
      img('LOOKBOOK RF_LL/project-027.webp'),
      img('LOOKBOOK RF_LL/project-028.webp'),
      img('LOOKBOOK RF_LL/project-029.webp'),
      img('LOOKBOOK RF_LL/project-030.webp'),
      img('LOOKBOOK RF_LL/project-031.webp'),
      img('LOOKBOOK RF_LL/project-032.webp'),
      img('LOOKBOOK RF_LL/project-033.webp'),
      img('LOOKBOOK RF_LL/project-056.webp'),
      img('LOOKBOOK RF_LL/project-058.webp'),
    ]
  },
  {
    id: '07',
    ...
    cover: img('LOGO DESIGN RF_LL CH2/project-0102.webp'),
    videos: [img('LOGO DESIGN RF_LL CH2/rfll-logo-anim.mp4')],
    images: [
      img('LOGO DESIGN RF_LL CH2/project-0102.webp'),
      img('LOGO DESIGN RF_LL CH2/project-095.webp'),
      img('LOGO DESIGN RF_LL CH2/project-096.webp'),
      img('LOGO DESIGN RF_LL CH2/project-097.webp'),
      img('LOGO DESIGN RF_LL CH2/project-098.webp'),
      img('LOGO DESIGN RF_LL CH2/project-099.webp'),
      img('LOGO DESIGN RF_LL CH2/project-0112.webp'),
      img('LOGO DESIGN RF_LL CH2/project-0113.webp'),
  ...
  },
  {
    ...
    cover: img('LUC LEQUEL/project-074.webp'),
    videos: [img('LUC LEQUEL/luc-lequel.mp4')],
    images: [
      img('LUC LEQUEL/project-074.webp'),
      img('LUC LEQUEL/project-075.webp'),
      img('LUC LEQUEL/project-076.webp'),
      img('LUC LEQUEL/project-077.webp'),
      img('LUC LEQUEL/project-078.webp'),
      img('LUC LEQUEL/project-079.webp'),
      img('LUC LEQUEL/project-080.webp'),
      img('LUC LEQUEL/project-081.webp'),
      img('LUC LEQUEL/project-082.webp'),
      img('LUC LEQUEL/project-083.webp'),
      img('LUC LEQUEL/project-084.webp'),
      img('LUC LEQUEL/project-085.webp'),
      img('LUC LEQUEL/project-086.webp'),
    ]
  },
  {
    id: '09',
    ...
    cover: img('TATO/POST 1.webp'),
    images: [
      img('TATO/POST 1.webp'),
      img('TATO/POST 2.webp'),
      img('TATO/POST 3.webp'),
      img('TATO/POST 4.webp'),
      img('TATO/POST 5.webp'),
      img('TATO/POST 6.webp'),
      img('TATO/POST 7.webp'),
      img('TATO/POST 9.webp'),
  ...
  },
  {
    ...
    cover: img('ARCHIVIO ROMANESE/POSTER ROMAENESE.webp'),
    images: [
      img('ARCHIVIO ROMANESE/POSTER ROMAENESE.webp'),
      img('ARCHIVIO ROMANESE/IMG_8585.webp'),
      img('ARCHIVIO ROMANESE/IMG_8587.webp'),
      img('ARCHIVIO ROMANESE/Screenshot 2026-07-31 alle 14.46.24.webp'),
      img('ARCHIVIO ROMANESE/Screenshot 2026-07-31 alle 14.46.38.webp'),
      img('ARCHIVIO ROMANESE/Screenshot 2026-07-31 alle 14.47.38.webp'),
    ]
  },
  {
    id: '10',
    ...
    cover: img('CARBONI/project-038.webp'),
    videos: [img('CARBONI/carboni-logo-anim.mp4')],
    images: [
      img('CARBONI/project-038.webp'),
      img('CARBONI/project-045.webp'),
      img('CARBONI/project-054.webp'),
      img('CARBONI/PORTFOLIO NUOVO copia.webp'),
      img('CARBONI/2013-01-22-sugar-3.webp'),
      img('CARBONI/Screenshot 2026-05-23 alle 18.56.36.webp'),
    ]
  },
  {
    id: '11',
    ...
    description: '',
    cover: img('ATELIER CORSA/project-012.webp'),
    images: [
      img('ATELIER CORSA/project-073.webp'),
      img('ATELIER CORSA/project-0104.webp'),
      img('ATELIER CORSA/project-012.webp'),
      img('ATELIER CORSA/project-013.webp'),
      img('ATELIER CORSA/project-0114.webp'),
    ]
  },
  {
    id: '12',
    ...
    description: '',
    cover: img('HOLY CITY/Foto scan holy city/Foto scan holy city.webp'),
    images: [
      img('HOLY CITY/Foto scan holy city/Foto scan holy city.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_5.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_6.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_7.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_8.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_11.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_12.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_13.webp'),
      img('HOLY CITY/Foto scan holy city/Foto scan holy city_14.webp'),
    ]
  },
  {
    id: '13',
    ...
    description: '',
    cover: img('ADIDAS OBD SCIARPE/project-0106.webp'),
    images: [
      img('ADIDAS OBD SCIARPE/project-0106.webp'),
      img('ADIDAS OBD SCIARPE/project-0107.webp'),
      img('ADIDAS OBD SCIARPE/project-0108.webp'),
      img('ADIDAS OBD SCIARPE/project-0109.webp'),
      img('ADIDAS OBD SCIARPE/project-0110.webp'),
      img('ADIDAS OBD SCIARPE/project-0111.webp'),
    ]
  },
];
...
const INDEX_IMAGES = [];
const indexPicks = {
  '01': ['project-01.webp', 'project-04.webp', 'project-07.webp'],
  '02': ['project-061.webp', 'project-057.webp', 'project-062.webp'],
  '03': ['project-015.webp', 'project-025.webp', 'project-042.webp'],
  '04': ['project-014.webp', 'project-022.webp', 'project-046.webp'],
  '05': ['project-090.webp', 'project-092.webp', 'project-094.webp'],
  '06': ['project-026.webp', 'project-030.webp', 'project-032.webp'],
  '07': ['project-0102.webp', 'project-095.webp', 'project-098.webp'],
  '08': ['project-074.webp', 'project-077.webp', 'project-082.webp'],
  '09': ['POST 1.webp', 'POST 4.webp'],
  '10': ['project-038.webp', 'project-045.webp'],
  '11': ['project-012.webp', 'project-073.webp', 'project-0104.webp'],
  '12': ['Foto scan holy city/Foto scan holy city.webp', 'Foto scan holy city/Foto scan holy city_5.webp', 'Foto scan holy city/Foto scan holy city_11.webp'],
  '13': ['project-0106.webp', 'project-0109.webp'],
  '14': ['POSTER ROMAENESE.webp', 'Screenshot 2026-07-31 alle 14.46.38.webp', 'IMG_8585.webp'],
};
